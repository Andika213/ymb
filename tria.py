...
# coding=utf-8
# Coded By Andika
# My Facebook ( https://www.facebook.com/andikapratama.dika.9655 )
...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Andika
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/Andika
 \033[0;96m  /_/       /_/  /_/____/_/ \033[0;91mv2.0  \033[0m|| Facebook.com/KM53'''
...
def yayanxd():
    ...
    try:
        ...
        os.system('xdg-open https://youtube.com/channel/UCtxwfkJYseUlQgR2Q2V_rqA ')
        moch_yayan()
    except KeyError:
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Akp galang.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Andika-pratama.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/Andika213'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/KM3'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/kandang.widiantara.50'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/Andikaxd_'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Website  : https://www.privasi.my.id'%(N,H,N);time.sleep(0.07)
